...
ResidentSpaceObject::ResidentSpaceObject()
{
	m_satellite = nullptr;
}
...
ResidentSpaceObject::ResidentSpaceObject(int ID, int numSegments, cSatellite* satellite, cJulian* localEpoch, elsetrec* TLEData)
{
	m_ID = ID;
...
ResidentSpaceObject::ResidentSpaceObject(const ResidentSpaceObject& rhs)
{
	copy(rhs);
}
...
ResidentSpaceObject& ResidentSpaceObject::operator=(const ResidentSpaceObject& rhs)
{
	if (this == &rhs)
		return *this;
...
void ResidentSpaceObject::copy(const ResidentSpaceObject& rhs)
{
	m_ID = rhs.m_ID;
	m_time = rhs.m_time;
	m_coord = rhs.m_coord;
...
void ResidentSpaceObject::clear()
{
}



void ResidentSpaceObject::initialize_replica(int numSegments)
{
...
void ResidentSpaceObject::change_num_segments(int numSegments)
{
	initialize_replica(numSegments);
}
...
rg_Point3D ResidentSpaceObject::calculate_point_on_Kepler_orbit_at_time_old(double time) const
{
...
rg_Point3D ResidentSpaceObject::calculate_point_on_Kepler_orbit_at_time(double time) const
{
	cJulian targetTime = *m_COOPEpoch;
	targetTime.AddSec(time);
...
rg_Point3D ResidentSpaceObject::calculate_replica_position_at_time(double time) const
{
...
double ResidentSpaceObject::calculate_segment_start_time(double time) const
{
...
double ResidentSpaceObject::calculate_seconds_from_perigee_to_local_epoch() const
{
...
void ResidentSpaceObject::update_circular_approximation(const rg_Point3D& pt0, const rg_Point3D& pt1, const rg_Point3D& pt2)
{
...
void ResidentSpaceObject::update_circular_approximation(const rg_Point3D& pt0, const rg_Point3D& pt1)
{
...
rg_Point3D ResidentSpaceObject::calculate_coord_of_perigee()
{
...
rg_Point3D ResidentSpaceObject::calculate_coord_of_circular_replica_at_time(const double& time)
{
...
rg_Point3D ResidentSpaceObject::calculate_coord_of_circular_replica_at_tau(const double& tau)
{
	rg_Point3D coordOfCircularReplica;
...
pair<double, double> ResidentSpaceObject::calculate_max_L2K_and_L2C_error_for_current_line_segment(int numSample)
{
...
double ResidentSpaceObject::calculate_max_L2K_error_for_current_line_segment(int numSample)
{
...
double ResidentSpaceObject::calculate_max_L2C_error_for_current_line_segment(int numSample)
{
	double maxDistance = 0;
...
double ResidentSpaceObject::calculate_max_C2K_error_for_current_line_segment(int numSample)
{
	double maxDistance = 0;
...
double ResidentSpaceObject::calculate_seconds_from_perigee(const cJulian& t) const
{
...
float ResidentSpaceObject::calculate_max_approximation_error()
{
...
void ResidentSpaceObject::move_to_next_segment()
{
...
rg_Point3D ResidentSpaceObject::calculate_position_at_time(double time) const
{
...
float ResidentSpaceObject::calculate_positional_error()
{
