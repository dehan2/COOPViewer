...
void RSOManager::generate_maneuver_plan(const int& targetCatalogID, const double& rotationAngle, const double& startTime, const double& endTime, const int& numSegments)
{
	...
	m_wayPoints.push_back(make_pair(initLocation, convert_seconds_to_tmStruct(m_startMomentOfPredictionTimeWindow, startTime)));
	...
	for (int i = 1; i <= numSegments; i++)
	{
		...
		m_wayPoints.push_back(make_pair(rotatedCoord, convert_seconds_to_tmStruct(m_startMomentOfPredictionTimeWindow, currTime)));
	}
}
...
void RSOManager::save_maneuver_plan(const string& filePath, const int& targetCatalogID, const double& rotationAngle, const double& startTime, const double& endTime, const int& numSegments)
{
	...
	tm startTimeInTM = convert_seconds_to_tmStruct(m_startMomentOfPredictionTimeWindow, startTime);
	tm endTimeInTM = convert_seconds_to_tmStruct(m_startMomentOfPredictionTimeWindow, endTime);
